...
function run_model() {
    OMP_NUM_THREADS=24 ./sch_1d -T 3.14 -t 0.01 -m $1 -N $2 -d $3
    #OMP_NUM_THREADS=32 ./sch_1d -T 3.14 -t 0.01 -m $1 -N $2 -d $3
    #./sch_1d -T 0.05 -t 0.01 -m $1 -N $2 -d $3
...
run_model harmonic_test_openmp 256 0.01
